    ...
    public function up(): void
    {
        if(!Schema::hasTable('acct_account')) {
            ...
            DB::table('acct_account')->insert([
                ...
                ['account_type_id' => 1,'account_code' => "201.01.1", 'account_name' => "Hutang Pihak Ke Tiga",                'account_group' => "201.01",'account_status' => "1",'account_default_status' => "1"],
                ['account_type_id' => 1,'account_code' => "201.01.2", 'account_name' => "Hutang Di Bank",                      'account_group' => "201.01",'account_status' => "1",'account_default_status' => "1"],
                ['account_type_id' => 1,'account_code' => "201.05",   'account_name' => "KEWAJIBAN JANGKA PANJANG",            'account_group' => "201",'account_status' => "0",'account_default_status' => "0"],
