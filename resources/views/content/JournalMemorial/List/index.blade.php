<x-base-layout>
    <div class="card">
        ...
        <form id="kt_filter_journal_memorial_form" class="form" method="POST"
            action="{{ route('journal-memorial.filter') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div id="kt_card_collapsible" class="collapse">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route('journal-memorial.reset-filter') }}" class="btn btn-danger me-2"
                        id="kt_filter_cancel">
                        {{ __('Batal') }}
                    </a>
