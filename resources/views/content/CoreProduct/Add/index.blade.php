                    ...
                    <div class="row mb-6">
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="name" id="name"
                                        ...
                                        value="{{ old('name', $sessiondata['name'] ?? '') }}" autocomplete="off"
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-auto fv-row">
                                    <input id="client_name" name="client_name"
                                        ...
                                        value="{{ old('client_name', $sessiondata['client_name'] ?? '') }}"
                                        readonly></input>
                                    <input id="client_id" name="client_id" type="hidden"
                                        value="{{ $sessiondata['client_id'] ?? '' }}"></input>
                                </div>
                                <div class="col-lg-auto fv-row">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="product_type_id" id="product_type_id" data-control="select2"
                                        ...
                                        @foreach ($type as $key => $value)
                                            <option data-kt-flag="{{ $key }}" value="{{ $key }}"
                                                {{ $key == old('product_type_id', $session['product_type_id'] ?? '') ? 'selected' : '' }}>
                                                {{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input name="trial_date" id="trial_date" type="date"
                                        class="form-control form-control-solid form-select-lg" placeholder="Tanggal"
                                        value="{{ old('trial_date', $sessiondata['trial_date'] ?? '') }}"
                                        onchange="function_elements_add(this.name, this.value)" />
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input name="usage_date" id="usage_date" type="date"
                                        class="form-control form-control-solid form-select-lg" placeholder="Tanggal"
                                        value="{{ old('usage_date', $sessiondata['usage_date'] ?? '') }}"
                                        onchange="function_elements_add(this.name, this.value)" />
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input name="maintenance_date" id="maintenance_date" type="date"
                                        class="form-control form-control-solid form-select-lg" placeholder="Tanggal"
                                        value="{{ old('maintenance_date', $sessiondata['maintenance_date'] ?? '') }}"
                                        onchange="function_elements_add(this.name, this.value)" />
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="payment_type" id="payment_type" data-control="select2"
                                        aria-label="Pilih Tipe Produk" data-placeholder="{{ __('Pilih Jenis Pembayaran') }}"
                                        data-allow-clear="true" class="form-select form-select-solid form-select-lg"
                                        onchange="function_elements_add(this.name, this.value)">
                                        <option value="">{{ __('Pilih') }}</option>
                                        @foreach ($pymentType as $key => $value)
                                            <option data-kt-flag="{{ $key }}" value="{{ $key }}"
                                                {{ $key == old('payment_type', $session['payment_type'] ?? '') ? 'selected' : '' }}>
                                                {{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    <input name="maintenance_price" type="hidden" id="maintenance_price"  value="{{ old('maintenance_price', $sessiondata['maintenance_price'] ?? '') }}"/>
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <textarea type="text" name="product_remark" id="product_remark"
                                        class="form-control form-control-lg form-control-solid" onchange="function_elements_add(this.name, this.value)" placeholder="Msukan Keterangan Produk">{{ old('product_remark', $sessiondata['product_remark'] ?? '') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="termin_total_view" id="termin_total_view"
                                        class="form-control form-control-lg form-control-solid" readonly placeholder="Total Termin" />
