    ...
    public function up(): void
    {
        if(!Schema::hasTable('acct_account')) {
            ...
            DB::table('acct_account')->insert([
                ...
                ['account_type_id' => 3,'account_code' => "402.01",   'account_name' => "Beban Pembelian Pantry",              'account_group' => "402",'account_status' => "0",'account_default_status' => "0"],
                ['account_type_id' => 3,'account_code' => "402.02",   'account_name' => "Beban Marketing dan Promosi",         'account_group' => "402",'account_status' => "0",'account_default_status' => "0"],
                ['account_type_id' => 3,'account_code' => "402.03",   'account_name' => "Beban Maintenance/Service",           'account_group' => "402",'account_status' => "0",'account_default_status' => "0"],
                ['account_type_id' => 3,'account_code' => "402.04",   'account_name' => "Beban Entertaintment",                'account_group' => "402",'account_status' => "0",'account_default_status' => "0"],
